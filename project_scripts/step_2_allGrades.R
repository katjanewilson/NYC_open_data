...
library(tidyverse)
setwd("/cloud/project/project_scripts")
third_grade_data <- read.csv("../data/fourth_grade_data_2017_Grade4.csv")
...
third_grade_data <- third_grade_data %>%
  mutate(only_gen_ed = ifelse(gifted_talented_option == 0 &
                                ...
                                GenEd == 1, 
                              1, 0))
write.csv(third_grade_data, '/cloud/project/data/fourth_grade_data_cleaned.csv')
######
# STEP 3
#find numbers/sample size
#######
...
working_data %>%
  group_by(gifted_talented_option) %>%
  summarise(mean_attendance = mean(Percent_Attendance))
write.csv(working_data, file = '/cloud/project/data/fourth_grade_data_cleaned.csv')



library(readr)
working_data <- read.csv('/cloud/project/data/fourth_grade_data_cleaned.csv')
...
library(tidyverse)
setwd("/cloud/project/project_scripts")
third_grade_data <- read.csv("../data/fifth_grade_data_Grade5.csv")
...
third_grade_data <- third_grade_data %>%
  mutate(only_gen_ed = ifelse(gifted_talented_option == 0 &
                                ...
                                GenEd == 1, 
                              1, 0))
write.csv(third_grade_data, '/cloud/project/data/fifth_grade_data_cleaned.csv')
######
# STEP 3
#find numbers/sample size
#######
...
working_data %>%
  group_by(gifted_talented_option) %>%
  summarise(mean_attendance = mean(Percent_Attendance))
write.csv(working_data, file = '/cloud/project/data/fifth_grade_data_cleaned.csv')




library(readr)
working_data <- read.csv('/cloud/project/data/fifth_grade_data_cleaned.csv')
## is the average attendance score among SC different than
## average attendance score among non SC
# install.packages("ggthemes")
library(ggthemes)
...
library(tidyverse)
setwd("/cloud/project/project_scripts")
third_grade_data <- read.csv("../data/sixth_grade_data_Grade6.csv")
...
third_grade_data <- third_grade_data %>%
  mutate(only_gen_ed = ifelse(gifted_talented_option == 0 &
                                ...
                                GenEd == 1, 
                              1, 0))
write.csv(third_grade_data, '/cloud/project/data/sixth_grade_data_cleaned.csv')
######
# STEP 3
#find numbers/sample size
#######
...
working_data %>%
  group_by(gifted_talented_option) %>%
  summarise(mean_attendance = mean(Percent_Attendance))
write.csv(working_data, file = '/cloud/project/data/sixth_grade_data_cleaned.csv')




library(readr)
working_data <- read.csv('/cloud/project/data/sixth_grade_data_cleaned.csv')
## is the average attendance score among SC different than
## average attendance score among non SC
# install.packages("ggthemes")
library(ggthemes)
...
library(tidyverse)
setwd("/cloud/project/project_scripts")
third_grade_data <- read.csv("../data/eigth_grade_data_2017_Grade8.csv")
...
third_grade_data <- third_grade_data %>%
  mutate(only_gen_ed = ifelse(gifted_talented_option == 0 &
                                ...
                                GenEd == 1, 
                              1, 0))
write.csv(third_grade_data, '/cloud/project/data/sixth_grade_data_cleaned_Grade8.csv')
######
# STEP 3
#find numbers/sample size
#######
...
working_data %>%
  group_by(gifted_talented_option) %>%
  summarise(mean_attendance = mean(Percent_Attendance))
write.csv(working_data, file = '/cloud/project/data/eigth_grade_data_cleaned.csv')
